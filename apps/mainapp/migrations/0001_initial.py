# Generated by Django 2.0.1 on 2019-06-28 18:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_is_select', models.BooleanField(default=False, verbose_name='是否选中')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('o_status', models.IntegerField(choices=[(0, '已下单未付款'), (1, '已下单已付款待收货'), (2, '下单后待评论')], default=0, verbose_name='订单状态')),
            ],
            options={
                'verbose_name': '订单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('0', '男'), ('1', '女')], default='0', max_length=10, verbose_name='性别')),
                ...
                ('img', models.ImageField(default='', upload_to='img/%Y/%m/%d', verbose_name='用户头像')),
